  ...
  return (
    <>
      <header className="header-background-img">
          ...
          <div className="row g-0 d-flex justifu-content-center align-items-center">
            <div className="col-12 col-sm-6 col-md-6 col-lg-2 ">
              <h4 className="text-light">
                <span className="text-warning">Make</span>MyTrip
              </h4>
            </div>
            ...
            <div className=" col-12 col-sm-6 col-md-6 col-lg-2 d-flex justify-content-end">
              <Custombutton
                variant="outlined"
                color="secondary"
                text1="Introducing MyBig "
                text2="Business Travel Solutions"
                size="large"
                fontsize="10px"
                fontcolor="white"
                className="w-100"
        ...
        <nav class="navbar navbar-expand-lg bg-light navbar-light p-3 rounded postion  shadow">
